    ...
    try{
        ...
        if(req.body.password === req.body.repassword){
          ...
          res.cookie('jwt',token, {
            expires: new Date(Date.now() + 90000),  //cookie remove automatically after 1min == 10000ms
...
app.post('/login', async(req, res) => {
    try{
      ...
      console.log('\nget cookie from browser: ',req.cookies.loginToken);  //return previous added cookie from web browser
...
app.get('/secret', auth, (req, res) => {
  // console.log('\nget cookie from browser: ',req.cookies.loginToken);
  res.render('secret');
})

// Used to delete cookie from browser
