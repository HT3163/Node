...
// app.get('*', (req,res)=>{   //* use for all other router enter by user
//   res.end('404')
// })   //Simple code

app.get('/about/*', (req,res)=>{   //* use for all other router enter by user
  res.render('404',{
    errorComment: '404 sorry! About page could be found'
  });
})    //use file to send as 404 code

app.get('*', (req,res)=>{   //* use for all other router enter by user
  res.render('404',{
    errorComment: '404 sorry! page could be found'
  });
})    //use file to send as 404 code
